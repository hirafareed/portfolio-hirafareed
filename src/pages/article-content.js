...
const articles = [
  {
    ...
    myRole: "Branding, \n User Research, \n UX/UI Design,  \n Prototyping ",
    overview:
      "BoardGamers help you locate players, groups, and gaming events all in one place without the need to spend hours on social platforms and different websites. It's as simple as posting your favourite game on this app where tons of players can connect, or you can simply join a gaming event. ",
